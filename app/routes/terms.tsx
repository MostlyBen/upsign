const Terms = () => {
  ...
  return (
    <div className="prose px-16 py-8">
      ...
      <p>By accessing or using this website, you agree to comply with and be bound by these Terms of Service. If you do not agree to these terms, please do not use our service.</p>

      <h2>2. Description of Service</h2>
      <p>Our website provides a platform for schools to create flexible schedules and allows students to sign in with Google and sign up for workshops created by teachers. This service is currently provided free of charge, but we reserve the right to change this in the future.</p>
